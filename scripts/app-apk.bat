...
REM OBS: build LOCAL p/ testar no celular. NAO sobe a versao nem publica Release.
REM Para release oficial (sobe versao + site + APK na nuvem), use: scripts\release.bat
