...
export const CAPABILITIES: Capability[] = [
  ...
  { id: 'logistica.volume.ver',         moduloChave: 'cap.modulo.logistica', labelChave: 'cap.logistica.volume.ver' },
  ...
  { id: 'estoque.expedicao.ver', moduloChave: 'cap.modulo.estoque', labelChave: 'cap.estoque.expedicao.ver' },
  ...
  { id: 'estoque.recebimento.gerenciar', moduloChave: 'cap.modulo.estoque', labelChave: 'cap.estoque.recebimento.gerenciar' },
  ...
  { id: 'ia.modelo_avancado',  moduloChave: 'cap.modulo.ia', labelChave: 'cap.ia.modelo_avancado' },
];
...
export const PERFIS_PADRAO: PerfilPadrao[] = [
  ...
  },
  {
    ...
    caps: ['dashboard.ver', 'ia.assistente.usar', 'financeiro.receber.listar', 'financeiro.receber.gerenciar', 'financeiro.pagar.listar', 'financeiro.pagar.gerenciar',
