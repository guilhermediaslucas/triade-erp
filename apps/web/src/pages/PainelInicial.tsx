...
export function PainelInicial() {
  ...
  if (temCapability('painel.tv_comercial')) return <Navigate to="/dashboard/tv" replace />;
  if (temCapability('painel.tv_expedicao')) return <Navigate to="/estoque/tv" replace />;
  return <Dashboard />;
}
