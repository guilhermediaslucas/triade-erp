...
Object.assign(pt, {
  ...
  'produtos.minimo': 'Estoque mínimo', 'produtos.sem_categoria': '(sem categoria)', 'produtos.todas_categorias': 'Todas categorias',
...
Object.assign(pt, {
  ...
  'cap.modulo.estoque': 'Estoque', 'cap.estoque.expedicao.ver': 'Ver expedição (Kanban)', 'cap.estoque.saldo.ver': 'Ver posição de estoque', 'cap.estoque.entrada.criar': 'Registrar entrada de estoque', 'cap.estoque.recebimento.gerenciar': 'Recebimento de mercadorias (por nota)',
...
Object.assign(pt, {
  ...
  'chamados.analisar_ia': 'Analisar com IA', 'chamados.analisando': 'Analisando…', 'chamados.analisar_pendentes': 'Analisar pendentes',
  'chamados.analise_ia': 'Análise da IA', 'chamados.causa': 'Causa provável', 'chamados.resposta_sugerida': 'Resposta sugerida ao usuário',
  'chamados.aplicar': 'Aplicar (responder + status)', 'chamados.aplicando': 'Aplicando…',
  'chamados.urg_alta': 'Urgência alta', 'chamados.urg_media': 'Urgência média', 'chamados.urg_baixa': 'Urgência baixa',
...
Object.assign(pt, {
  ...
  'dash.por_produto': 'Vendas por produto', 'dash.escolha_categoria': 'Escolha uma categoria para ver os mais vendidos', 'dash.top_cli_valor': 'Top 10 clientes', 'dash.top_cli_qtd': 'Top 10 clientes',
  'fin.forma': 'Forma',
...
Object.assign(pt, {
  ...
  'cap.logistica.volume.ver': 'Ver volume de entregas',
  ...
  'rastreio.confirmar_entrega': 'Confirmar entrega', 'rastreio.codigo_telefone_label': '4 últimos dígitos do telefone do cliente', 'rastreio.codigo_telefone_hint': 'Peça ao cliente os 4 últimos números do telefone cadastrado. Código errado não finaliza a entrega.', 'rastreio.siga_rota': 'siga a ordem da rota', 'rastreio.proxima': 'Próxima',
  'rastreio.entrega': 'Entrega', 'rastreio.de': 'de', 'rastreio.restantes': 'restantes', 'rastreio.parada_atual': 'Parada atual', 'rastreio.proximas_paradas': 'Próximas paradas', 'rastreio.navegar': 'Navegar',
  ...
  'rastreio.selecione': 'Selecione uma entrega para ver no mapa.', 'rastreio.atualizado_em': 'Atualizado em', 'rastreio.faltam': 'Faltam',
  'rastreio.link_motoboy_btn': 'Link do motoboy (avulso)', 'rastreio.link_motoboy_copiado': 'Link do motoboy copiado!', 'rastreio.link_motoboy': 'Link do motoboy avulso:', 'rastreio.erro_status': 'Não foi possível atualizar a entrega.', 'rastreio.aguardando_msg_motoboy': 'Mantenha esta tela aberta para enviar sua localização.',
  'entrega.sem_motoboy': 'Seu login não está vinculado a um motoboy.', 'entrega.nao_sua': 'Esta entrega não é sua.', 'entrega.status_invalido': 'Status de entrega inválido.', 'entrega.posicao_invalida': 'Posição inválida.', 'entrega.nao_motoboy': 'O pedido não é entrega por motoboy.',
  'refazer.btn': 'Refazer entrega', 'refazer.titulo': 'Refazer entrega — novo endereço', 'refazer.endereco': 'Novo endereço de entrega', 'refazer.endereco_ph': 'Rua, número, bairro, cidade/UF', 'refazer.valor': 'Valor do novo frete (R$)', 'refazer.quem_paga': 'Quem paga este frete?', 'refazer.cliente': 'Cobrar do cliente', 'refazer.empresa': 'Empresa absorve', 'refazer.nota': 'Gera o frete a pagar ao motoboy pela nova tentativa; se "cobrar do cliente", também um título a receber. A entrega volta para "aguardando" (gere um novo link do motoboy).', 'refazer.gerar': 'Gerar frete', 'refazer.ok': 'Re-entrega gerada.', 'pedido.endereco_obrigatorio': 'Informe o novo endereço.',
  ...
  'rastreio.mapa_sem_chave': 'Para ver o mapa aqui dentro, configure a chave do Google Maps (VITE_GOOGLE_MAPS_KEY) no site.',
...
Object.assign(en, {
  ...
  'rastreio.selecione': 'Select a delivery to view on the map.', 'rastreio.atualizado_em': 'Updated at', 'rastreio.faltam': 'ETA',
  'rastreio.link_motoboy_btn': 'Courier link (freelance)', 'rastreio.link_motoboy_copiado': 'Courier link copied!', 'rastreio.link_motoboy': 'Freelance courier link:', 'rastreio.erro_status': 'Could not update the delivery.', 'rastreio.aguardando_msg_motoboy': 'Keep this screen open to send your location.',
  'entrega.sem_motoboy': 'Your login is not linked to a courier.', 'entrega.nao_sua': 'This delivery is not yours.', 'entrega.status_invalido': 'Invalid delivery status.', 'entrega.posicao_invalida': 'Invalid position.', 'entrega.nao_motoboy': 'The order is not a courier delivery.',
  'refazer.btn': 'Redo delivery', 'refazer.titulo': 'Redo delivery — new address', 'refazer.endereco': 'New delivery address', 'refazer.endereco_ph': 'Street, number, district, city', 'refazer.valor': 'New freight value', 'refazer.quem_paga': 'Who pays this freight?', 'refazer.cliente': 'Charge the customer', 'refazer.empresa': 'Company absorbs', 'refazer.nota': 'Creates the courier payable for the new attempt; if "charge the customer", also a receivable. The delivery returns to "waiting" (generate a new courier link).', 'refazer.gerar': 'Generate freight', 'refazer.ok': 'Re-delivery created.', 'pedido.endereco_obrigatorio': 'Enter the new address.',
...
Object.assign(es, {
  ...
  'rastreio.selecione': 'Selecciona una entrega para verla en el mapa.', 'rastreio.atualizado_em': 'Actualizado el', 'rastreio.faltam': 'Faltan',
  'rastreio.link_motoboy_btn': 'Enlace del motoboy (freelance)', 'rastreio.link_motoboy_copiado': '¡Enlace del motoboy copiado!', 'rastreio.link_motoboy': 'Enlace del motoboy freelance:', 'rastreio.erro_status': 'No se pudo actualizar la entrega.', 'rastreio.aguardando_msg_motoboy': 'Mantén esta pantalla abierta para enviar tu ubicación.',
  'entrega.sem_motoboy': 'Tu login no está vinculado a un motoboy.', 'entrega.nao_sua': 'Esta entrega no es tuya.', 'entrega.status_invalido': 'Estado de entrega inválido.', 'entrega.posicao_invalida': 'Posición inválida.', 'entrega.nao_motoboy': 'El pedido no es entrega por motoboy.',
  'refazer.btn': 'Rehacer entrega', 'refazer.titulo': 'Rehacer entrega — nueva dirección', 'refazer.endereco': 'Nueva dirección de entrega', 'refazer.endereco_ph': 'Calle, número, barrio, ciudad', 'refazer.valor': 'Valor del nuevo flete', 'refazer.quem_paga': '¿Quién paga este flete?', 'refazer.cliente': 'Cobrar al cliente', 'refazer.empresa': 'La empresa absorbe', 'refazer.nota': 'Genera el flete a pagar al motoboy por el nuevo intento; si "cobrar al cliente", también un título a cobrar. La entrega vuelve a "esperando" (genera un nuevo enlace del motoboy).', 'refazer.gerar': 'Generar flete', 'refazer.ok': 'Reentrega generada.', 'pedido.endereco_obrigatorio': 'Informa la nueva dirección.',
