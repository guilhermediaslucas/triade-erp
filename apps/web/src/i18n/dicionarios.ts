...
Object.assign(pt, {
  ...
  'metas.crumb': 'Comercial / Metas', 'metas.titulo': 'Metas', 'metas.sub': 'Metas de faturamento por período',
  'metas.dia': 'Meta diária (R$)', 'metas.semana': 'Meta semanal (R$)', 'metas.mes': 'Meta mensal (R$)', 'metas.ano': 'Meta anual (R$)',
  'metas.salvar': 'Salvar metas', 'metas.salvo': 'Metas salvas', 'metas.nota': 'A meta mensal aparece como barra vermelha no gráfico do dashboard; a meta diária, no painel da TV.',
  'meta.valor_invalido': 'Valor de meta inválido (informe um número ≥ 0).',
...
Object.assign(en, {
  ...
  'metas.crumb': 'Sales / Targets', 'metas.titulo': 'Targets', 'metas.sub': 'Revenue targets by period',
  'metas.dia': 'Daily target (R$)', 'metas.semana': 'Weekly target (R$)', 'metas.mes': 'Monthly target (R$)', 'metas.ano': 'Yearly target (R$)',
  'metas.salvar': 'Save targets', 'metas.salvo': 'Targets saved', 'metas.nota': 'The monthly target shows as a red bar on the dashboard chart; the daily target, on the TV panel.',
  'meta.valor_invalido': 'Invalid target value (enter a number ≥ 0).',
...
Object.assign(es, {
  ...
  'cap.comercial.meta.ver': 'Ver metas', 'cap.comercial.meta.gerenciar': 'Definir metas',
  'metas.crumb': 'Comercial / Metas', 'metas.titulo': 'Metas', 'metas.sub': 'Metas de facturación por período',
  'metas.dia': 'Meta diaria (R$)', 'metas.semana': 'Meta semanal (R$)', 'metas.mes': 'Meta mensual (R$)', 'metas.ano': 'Meta anual (R$)',
  'metas.salvar': 'Guardar metas', 'metas.salvo': 'Metas guardadas', 'metas.nota': 'La meta mensual aparece como barra roja en el gráfico del panel; la meta diaria, en el panel de TV.',
  'meta.valor_invalido': 'Valor de meta inválido (ingrese un número ≥ 0).',
